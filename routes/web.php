...
Route::get('/testcreateorder', [CheckoutController::class, 'createOrderFromCartSimple']);
Route::get('/testtelegram/{id}', [CheckoutController::class, 'sendTelegram']);
Route::get('/testmail/{id}', [CheckoutController::class, 'sendMail']);


Route::get('/test-bakong', [CheckoutController::class, 'testBakong']);
