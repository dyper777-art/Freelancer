...
@section('content')
    ...
    <section id="contact" class="contact section">
        ...
        <div class="container section-title aos-init aos-animate" data-aos="fade-up">
            <h2>REGISTER</h2>
                        <a href="{{ route('login.form') }}"><i class="bi bi-arrow-left">&nbsp;&nbsp;Go To Login</i></a>
        ...
        <div class="container aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gx-lg-0 gy-4">
                ...
                <div class="col-lg-8">
                    <form action="{{ route('register') }}" method="post" class="sign-form aos-init aos-animate"
                        ...
                        <div class="row d-flex align-items-center justify-content-center gy-4">
                             ...
                             <div class="col-md-12 ">
                                <input type="text" class="form-control" name="name" placeholder="Your Name"
                                    required="" data-sharkid="__1" data-sharklabel="name" required>
